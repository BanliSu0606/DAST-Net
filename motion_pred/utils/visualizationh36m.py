...
if __name__ == '__main__':
    index = 85
    data_path_1 = './results/h36m_25_100/results/gt_pred.npz'
    data_path_2 = './results/h36m_25_100_gcnext/results/gt_pred.npz'
    save_path = './results_vis/h36m_STvsGCNext' + str(index)
