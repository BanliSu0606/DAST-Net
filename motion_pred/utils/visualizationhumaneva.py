...
if __name__ == '__main__':
    index = 85
    data_path_1 = './results/humaneva_25_100/results/gt_pred.npz'
    data_path_2 = './results/humaneva_25_100_gcnext/results/gt_pred.npz'
    save_path = './results_vis/humaneva_STvsGCNext' + str(index)
